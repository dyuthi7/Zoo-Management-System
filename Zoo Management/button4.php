...
<h1 style="color:WHITE;">CLINIC DATABASE</h1>

<h2 style="color:WHITE;">For SPECIFIC clinics click here:<h2>

<form action="new4.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<h2 style="color:WHITE;">All clinics<h2>

<form action="nclin.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<body style = "background : url(https://images.unsplash.com/photo-1599557835468-29bb0b3155cd?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80);background-size: cover; ">
  <h2 style="color:WHITE;">ADD to database<h2>
    <button onclick="location.href='c22.html'" button class="btn btn-secondary">Add</button>
</html>
</body>
