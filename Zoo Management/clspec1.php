...
<body>
  <h1> CLINIC NO: 50  DATABASE </h1>
  <table>
    <tr>
      <th style="font-size: 20px">Animal_no</th>
      <th style="font-size: 20px">Cage_no</th>
      <th style="font-size: 20px">Clinic_id</th>
      <th style="font-size: 20px">Treatment</th>
      <th style="font-size: 20px">Type_of_ailment</th>
    </tr>
<?php
...
$sql = "SELECT animal_no, cage_no, clinic_id, treatment, type_of_ailment, vet_id FROM clinic WHERE clinic_id=50";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td style="font-size: 20px"><?php echo $row["clinic_id"]; ?></td>
