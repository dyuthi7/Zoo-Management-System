...
$sql = "SELECT cage_no, CT_id, f_fname, f_lname, quant_of_food, ST_id, type_of_food FROM foodstore";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td style="font-size: 20px"><?php echo $row["f_fname"]; ?></td>
