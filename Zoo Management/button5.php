...
<h1 style="color:WHITE;">FOOD STORAGE DATABASE</h1>

<h2 style="color:WHITE;"> For SPECIFIC food storage click here:<h2>

<form action="new5.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<h2 style="color:WHITE;">All storages<h2>

<form action="nf.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>
<body style = "background : url(https://images.unsplash.com/photo-1569718974246-7b898eae87d3?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80);background-size: cover; ">
  <h2 style="color:WHITE;">ADD to database<h2>
    <button onclick="location.href='f22.html'" button class="btn btn-secondary">Add</button>
</html>
</body>
