...
<body>
  <h1> Animal id: 1 Database </h1>
  <table>
    <tr>
      <th style="font-size: 20px">Animal_name</th>
      <th style="font-size: 20px">Animal_no</th>
      <th style="font-size: 20px">Animal_type</th>
      <th style="font-size: 20px">Cage_no</th>
      <th style="font-size: 20px">Gender</th>
      <th style="font-size: 20px">No_of_descendants</th>
      </tr>
<?php
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ?>
        <tr>
            <th style="font-size: 20px"><?php echo $row["animal_name"]; ?></th>
            <th style="font-size: 20px"><?php echo $row["animal_no"]; ?></th>
            <th style="font-size: 20px"><?php echo $row["animal_type"]; ?></th>
            <th style="font-size: 20px"><?php echo $row["cage_no"]; ?></th>
            <th style="font-size: 20px"><?php echo $row["gender"]; ?></th>
            <th style="font-size: 20px"><?php echo $row["no_of_descendants"]; ?></th>
        </tr>
          <?php
    }
} else {
